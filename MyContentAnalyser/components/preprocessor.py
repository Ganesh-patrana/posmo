...
class PreProcessText:
    ...
    def __init__(self, language="en"):
        ...
        stopwords_file = open(
            r"C:\Users\jc\pratian\final-project-execution\ContentAnalyser\MyContentAnalyser\components\json_files\stopwords.json"
        )
        punctuations_file = open(
            r"C:\Users\jc\pratian\final-project-execution\ContentAnalyser\MyContentAnalyser\components\json_files\punctuations.json"
        )
